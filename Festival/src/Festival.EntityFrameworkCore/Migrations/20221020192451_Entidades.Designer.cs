...
namespace Festival.Migrations
{
    ...
    [Migration("20221020192451_Entidades")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Festival.Apuestas.Apuesta", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppApuestas", (string)null);
                });

            modelBuilder.Entity("Festival.Equipos.Equipo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppEquipos", (string)null);
                });

            modelBuilder.Entity("Festival.Partidos.Partido", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("EquipoAId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("EquipoBId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("ResultadoEquipoA")
                        .HasColumnType("int");

                    b.Property<int>("ResultadoEquipoB")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppPartidos", (string)null);
                });

            modelBuilder.Entity("Festival.Predicciones.Prediccion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ApuestaId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("PrediccionResultadoEquipoA")
                        .HasColumnType("int");

                    b.Property<int>("PrediccionResultadoEquipoB")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppPredicciones", (string)null);
                });
            ...
            modelBuilder.Entity("Festival.Predicciones.Prediccion", b =>
                {
                    b.HasOne("Festival.Apuestas.Apuesta", "Apuesta")
                        .WithMany("Predicciones")
                        .HasForeignKey("ApuestaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Festival.Partidos.Partido", "Partido")
                        .WithMany()
